...
#### abortEarly
[`abortEarly.test.js`](`https://github.com/AndrewKeig/express-validation/blob/master/__tests__/integration/abortEarly.test.js`)

You can return multiple errors, not just the first encountered, by setting, the joi option `abortEarly: false`

#### context
[`context.test.js`](`https://github.com/AndrewKeig/express-validation/blob/master/__tests__/integration/context.test.js`)

Enabling the `context` in `options`, allows you to reference other parts of the request in your validation.

#### defaults
[`default.test.js`](`https://github.com/AndrewKeig/express-validation/blob/master/__tests__/integration/defaults.test.js`)
