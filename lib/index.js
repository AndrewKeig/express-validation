...
module.exports = function (schema) {
  ...
  return function (req, res, next)  {
    ...
    pushErrors(errors, validate(errors, req.headers, schema.headers, 'headers', true));
    pushErrors(errors, validate(errors, req.body, schema.body, 'body', false));
    pushErrors(errors, validate(errors, req.query, schema.query, 'query', false));
    pushErrors(errors, validate(errors, _.extend({}, req.params), schema.params, 'params', false));
